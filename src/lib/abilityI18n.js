const ABILITY_EN = {
  ...
  deb_aura: { name: "Expedition", desc: "On entry, all allied Robots gain +2 ATT for 4 turns." },
  ...
  fourmori_buff: { name: "Airdrop", desc: "If its attack hits, allies gain +6 SPD." },
  ...
  fierononno_swap: { name: "HODL Testnet", desc: "If its ally Protects, it swaps position with that ally." },
  long_stable: { name: "Airdrop Claim", desc: "Does not suffer stat drops and gains +6 ATT." },
